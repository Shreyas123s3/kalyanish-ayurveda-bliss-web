      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {treatments.map((treatment, index) => (
            <div 
              key={index}
              className="bg-white/40 backdrop-blur-md rounded-3xl p-6 shadow-xl border border-amber-200/50 hover:shadow-2xl hover:scale-105 transition-all duration-300 group"
            >
