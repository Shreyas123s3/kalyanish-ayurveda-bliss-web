    ...
    <section id="home" className="min-h-screen flex items-center justify-center px-4 pt-16">
      <div className="text-center max-w-4xl mx-auto">
        <div className="animate-fade-in">
          {/* Kalyanish Ayurveda Logo - Enlarged to 2x size */}
          <div className="mb-6">
            <img 
              src="/lovable-uploads/923502a0-6e93-44a1-b556-0c49735d8a86.png" 
              alt="Kalyanish Ayurveda Logo" 
              className="mx-auto w-auto h-56 md:h-80 object-contain hover:scale-105 transition-transform duration-300 ease-in-out"
            />
          </div>
          
          {/* Heading - moved closer to logo */}
          ...
          {/* Subheading - moved closer to heading */}
          ...
          {/* CTA Button - aligned perfectly below subheading */}
          <EnhancedButton 
